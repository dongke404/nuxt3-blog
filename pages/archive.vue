...
<template>
  <div class="archive-page">
    <CommonPageBanner :position="32" image="https://cdn.pixabay.com/index/2023/02/16/08-11-07-185_1920x550.jpg">
      <template #title>
        归档
      </template>
              ...
              <div class="archive-article">
                <div class="left">
                  <h3 class="title">
                    ...
                    <nuxt-link :to="`/article/${article.article_id}`" target="_blank" class="link" :title="article.title">
                      {{ article.title }}
                    </nuxt-link>
                  </h3>
