...
<template>
  <header class="header module-bg dark:dark-module-bg">
    ...
    <transition name="module">
      <div v-if="searchState.open" class="search-mask module-bg-translucent dark:dark-module-bg-translucent" @click="cancelSearch" />
    </transition>
    <nav class="navbar">
